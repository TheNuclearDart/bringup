...
// @JDM not sure this is the best place for this to live in the end, but for now
// Copied from CubeMx generated code
...
// @JDM My own additions
#define USER_PUSH_BUTTON_PIN GPIO_PIN_11
#define USER_PUSH_BUTTON_PORT GPIOI
