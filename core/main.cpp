...
int main(void)
{
   ...
   Print print(uart1, UINT32_MAX); // Need to determine better timeout
   char data[8] = {0};
   data[0] = 'T';
   data[1] = 'E';
   data[2] = 'S';
   ...
   while (1)
   {
      ...
      //HAL_Delay(100); // Not working; something is setup wrong with systick. Something isn't setup yet in terms of ISR
   }
